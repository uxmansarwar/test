...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/ys/r/K8CKxEt6QIN.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
      ...
      array (
        'name' => ':path',
        'value' => '/rsrc.php/v3/ys/r/K8CKxEt6QIN.js?_nc_x=Ij3Wp8lg5Kz',
      ),
      3 => 
      array (
        'name' => ':scheme',
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'expires',
        'value' => 'Sun, 13 Apr 2025 10:17:20 GMT',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=47, rtx=72, c=4, mss=1232, tbw=172725, tp=159, tpl=72, uplat=0, ullat=-1',
      ),
      21 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'IwGlLogNKvMTwMwXe8SkhLHELm2Be0AvpF2NBSvR8IOzeeW7xLwv+mRAQRkpcvtdxEaEE+UIv9M3O6X1pK3HWw==',
      ),
    ),
    'cookies' => 
    array (
...
__d("LSWriteThreadCapabilities",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[],d=[];return b.sequence([function(d){return c[0]=b.i64.of_float(Date.now()),b.forEach(b.db.table(9).fetch([[[a[0]]]]),function(b){var c=b.update;b.item;return c({capabilities:a[1],capabilities2:a[2],capabilities3:a[3],capabilities4:a[4]})})},function(a){return b.resolve(d)}])}e.exports=a}),null);',
  ...
  'startedDateTime' => '2024-04-20T11:13:19.791Z',
  'time' => 215.06600000429899,
  'timings' => 
  array (
    'blocked' => 113.03800002315081,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0.41800000000000637,
    'wait' => 58.02799999727681,
    'receive' => 43.581999983871356,
    '_blocked_queueing' => 2.5830000231508166,
  ),
)