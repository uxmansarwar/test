  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=44, rtx=0, c=39, mss=1232, tbw=6111, tp=15, tpl=0, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'YWMQGNjWJafzXRrMZdF6xCcNWpIOgPYXWzTihG9AIDC/olVkr3yluSJuaJYR3NDX478hXUg1OnGemz2WxwXB6A==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
...
__d("SecurePostMessage",["invariant"],(function(a,b,c,d,e,f,g){"use strict";var h="*";a={sendMessageToSpecificOrigin:function(a,b,c,d){c!==h||g(0,21157),a.postMessage(b,c,d)},sendMessageForCurrentOrigin:function(a,b){a.postMessage(b)},sendMessageAllowAnyOrigin_UNSAFE:function(a,b,c){a.postMessage(b,h,c)}};e.exports=a}),null);',
  ...
  'startedDateTime' => '2024-04-20T11:13:26.695Z',
  'time' => 640.0680000078864,
  'timings' => 
  array (
    'blocked' => 638.1240000159219,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 0.8830000038519501,
    'receive' => 1.0609999881125987,
    '_blocked_queueing' => 637.9210000159219,
  ),
)