...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/yU/r/CgAuSM9NTZp.js?_nc_x=Ij3Wp8lg5Kz',
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'x-fb-debug',
        'value' => 'edXZo+0OkN5yiKEkEqZ/6saDWI6KD2XQpJaHouoehojW7dyEoRp9G6pCcjQ8SndbZL/dvOpArkEH7fscRDlZOA==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Mon, 28 Apr 2025 16:32:38 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("LSDeleteThenInsertMessagingPrivacySettings",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[];return b.sequence([function(c){return b.db.table(288).put({userId:a[0],readReceiptsDisabled:a[1],e2eeXmaPreviewsDisabled:a[3]})},function(a){return b.resolve(c)}])}e.exports=a}),null);',
  ...
  'time' => 5.292999998346204,
  'timings' => 
  array (
    'blocked' => 1.201999999996624,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 1.132000000704429,
    'receive' => 2.958999997645151,
    '_blocked_queueing' => 1.036999999996624,
  ),
)