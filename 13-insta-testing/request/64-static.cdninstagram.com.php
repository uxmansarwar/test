...
return array (
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        8 => 
        array (
          'functionName' => 'i.applyWithGuard.name',
          'scriptId' => '581',
          'url' => 'https://static.cdninstagram.com/rsrc.php/v3iscu4/yx/l/makehaste_jhash/opkrFbU7K5v.js?_nc_x=Ij3Wp8lg5Kz',
          'lineNumber' => 176,
          'columnNumber' => 1122,
        ...
        24 => 
        array (
          'functionName' => 'g.unstable_runWithPriority',
          'scriptId' => '582',
          'url' => 'https://static.cdninstagram.com/rsrc.php/v3/yL/r/gzOEkp8ap8N.js?_nc_x=Ij3Wp8lg5Kz',
          'lineNumber' => 228,
          'columnNumber' => 4281,
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/yE/r/cBFCVY2lkZ1.js?_nc_x=Ij3Wp8lg5Kz',
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'date',
        'value' => 'Sun, 05 May 2024 13:15:02 GMT',
      ),
      1 => 
      array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=1, rtx=2, c=777, mss=1348, tbw=4168922, tp=-1, tpl=-1, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'vGnWDA9gsCCQIq/0+chVBEgrtTSdKznyVUSe06fhY7PNlOjsgVpOEf+9xw2bA9EWN6eyIVX5zzh3+XXmDYMeeg==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Fri, 25 Apr 2025 01:26:58 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("LSClearPinnedMessages",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[];return b.sequence([function(c){return b.forEach(b.db.table(205).fetch([[[a[0]]]]),function(a){return a["delete"]()})},function(a){return b.resolve(c)}])}e.exports=a}),null);
__d("LSDeleteExistingMessageRanges",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[];return b.sequence([function(c){return b.forEach(b.db.table(13).fetch([[[a[0]]]]),function(a){return a["delete"]()})},function(a){return b.resolve(c)}])}e.exports=a}),null);
__d("LSDeleteThenInsertIgThreadInfo",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[];return b.sequence([function(c){return b.db.table(194).put({threadKey:a[0],igThreadId:a[1],igDmSettingsMode:a[2],igDmSettingsTtlSec:a[3],igDmSettingsLastSetActorId:a[4],igDmSettingsLastSetTimestampMs:a[5]})},function(a){return b.resolve(c)}])}e.exports=a}),null);
...
__d("LSWriteThreadCapabilities",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[],d=[];return b.sequence([function(d){return c[0]=b.i64.of_float(Date.now()),b.forEach(b.db.table(9).fetch([[[a[0]]]]),function(b){var c=b.update;b.item;return c({capabilities:a[1],capabilities2:a[2],capabilities3:a[3],capabilities4:a[4]})})},function(a){return b.resolve(d)}])}e.exports=a}),null);',
  ...
  'startedDateTime' => '2024-05-05T15:15:19.479Z',
  'time' => 5.9600000004138565,
  'timings' => 
  array (
    'blocked' => 1.5980000007047201,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 2.424999999711057,
    'receive' => 1.9369999999980791,
    '_blocked_queueing' => 1.4770000007047202,
  ),
)