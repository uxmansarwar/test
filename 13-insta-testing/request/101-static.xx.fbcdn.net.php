...
return array (
  ...
  array (
    ...
    array (
      ...
      array (
        'id' => '4',
        'debuggerId' => '4794606241586631279.743353055573011654',
      ),
    ),
  ),
  '_priority' => 'High',
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.xx.fbcdn.net/rsrc.php/v3/yW/r/z2-fs3AwDxh.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'date',
        'value' => 'Sun, 05 May 2024 13:15:19 GMT',
      ),
      1 => 
      array (
      ...
      array (
        ...
        'value' => 'GOOD; q=0.7, rtt=117, rtx=0, c=269, mss=1232, tbw=295535, tp=253, tpl=0, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'm6PEKXgWvRs1xRUGQsLbVyA1JGEnXOj3KZ1T/MudMuMDL8stWymfu5gXJozcKN7/62X+YSBvb5X9KqdhZwvgLA==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Sat, 03 May 2025 15:26:55 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("setImmediate",["TimeSlice","TimerStorage","setImmediateAcrossTransitions"],(function(a,b,c,d,e,f,g){function a(a){var b,d=function(){c("TimerStorage").unset(c("TimerStorage").IMMEDIATE,b);for(var d=arguments.length,e=new Array(d),f=0;f<d;f++)e[f]=arguments[f];Function.prototype.apply.call(a,this,e)};c("TimeSlice").copyGuardForWrapper(a,d);for(var e=arguments.length,f=new Array(e>1?e-1:0),g=1;g<e;g++)f[g-1]=arguments[g];b=c("setImmediateAcrossTransitions").apply(void 0,[d].concat(f));c("TimerStorage").set(c("TimerStorage").IMMEDIATE,b);return b}g["default"]=a}),98);',
  ...
  'serverIPAddress' => '[2a03:2880:f00c:212:face:b00c:0:3]',
  'startedDateTime' => '2024-05-05T15:32:24.703Z',
  'time' => 5.146999999851687,
  'timings' => 
  array (
    'blocked' => 3.07299999861978,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 0.5180000001582084,
    'receive' => 1.5560000010736985,
    '_blocked_queueing' => 2.61799999861978,
  ),
)