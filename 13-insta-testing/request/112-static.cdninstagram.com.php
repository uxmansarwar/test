...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/yP/r/Cc3kFTcM6oy.js?_nc_x=Ij3Wp8lg5Kz',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=2, rtx=6, c=1010, mss=1348, tbw=5592401, tp=-1, tpl=-1, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'LiIA2HBAkPvEujZrjHW3kbgMs9mU5CNDAMQof/+vXnyX424HYo8CdZGaEqbLS5+JC2OfgepygGLIVy/8IShc+g==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Mon, 28 Apr 2025 16:32:02 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("LSEpdCookieSettingsUpsert",["LSGetViewerFBID"],(function(a,b,c,d,e,f){function a(){var a=arguments,c=a[a.length-1],d=[],e=[];return c.sequence([function(e){return c.sequence([function(a){return c.storedProcedure(b("LSGetViewerFBID")).then(function(a){return a=a,d[0]=a[0],a})},function(b){return c.db.table(163).put({fbTrackersOnOtherCompanies:a[0],otherCompanyTrackersOnFoa:a[1]})}])},function(a){return c.resolve(e)}])}e.exports=a}),null);',
  ...
  'startedDateTime' => '2024-05-05T15:32:28.038Z',
  'time' => 4.487000000153785,
  'timings' => 
  array (
    'blocked' => 1.5869999989412027,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 1.294999999921536,
    'receive' => 1.605000001291046,
    '_blocked_queueing' => 1.4099999989412026,
  ),
)