  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=1, rtx=6, c=1010, mss=1348, tbw=5593337, tp=-1, tpl=-1, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'D0aY4CN4TnASAza1XI3Tg8J/gMg02ufxH07AWrmqPJmvM0pMk6jfanEeyJQw1LnkITnORnFpk0jpgmF69M0T+A==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Tue, 22 Apr 2025 17:45:49 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("LSTruncateQuietTime",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[];return b.sequence([function(a){return b.forEach(b.db.table(317).fetch(),function(a){return a["delete"]()})},function(a){return b.resolve(c)}])}e.exports=a}),null);',
  ...
  'startedDateTime' => '2024-05-05T15:32:29.131Z',
  'time' => 6.476000000475324,
  'timings' => 
  array (
    'blocked' => 1.1810000003806782,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 1.0369999992490047,
    'receive' => 4.258000000845641,
    '_blocked_queueing' => 1.065000000380678,
  ),
)