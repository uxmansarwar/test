...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/yX/r/iHa8250MaUp.js?_nc_x=Ij3Wp8lg5Kz',
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'date',
        'value' => 'Sun, 05 May 2024 13:14:59 GMT',
      ),
      1 => 
      array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=1, rtx=2, c=777, mss=1348, tbw=3725506, tp=-1, tpl=-1, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'ErBBQyGoFQFlihAmO49evnq/++bLBvRwQCWvJC4TTy7ospNH9dlq3Lndzfrea54JZLE6mHVjZY71+ETtxUiflg==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Sun, 04 May 2025 15:47:30 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("PolarisClipsTabDesktopContainerDirectQuery_instagramRelayOperation",[],(function(a,b,c,d,e,f){e.exports="25396858289928917"}),null);
...
__d("PolarisClipsTabDesktopContainerQuery$Parameters",["PolarisShareMenu.relayprovider"],(function(a,b,c,d,e,f){"use strict";a={kind:"PreloadableConcreteRequest",params:{id:"8282754855072849",metadata:{},name:"PolarisClipsTabDesktopContainerQuery",operationKind:"query",text:null,providedVariables:{__relay_internal__pv__PolarisShareMenurelayprovider:b("PolarisShareMenu.relayprovider")}}};e.exports=a}),null);
__d("PolarisClipsTabDesktopNonProfiledContainerQuery_instagramRelayOperation",[],(function(a,b,c,d,e,f){e.exports="7612730565430234"}),null);
...
__d("PolarisExploreRoot.entrypoint",["JSResourceForInteraction"],(function(a,b,c,d,e,f,g){"use strict";a={getPreloadProps:function(a){return{queries:{}}},root:c("JSResourceForInteraction")("PolarisExploreRoot.react").__setRef("PolarisExploreRoot.entrypoint")};g["default"]=a}),98);',
  ...
  'startedDateTime' => '2024-05-05T15:32:23.534Z',
  'time' => 23.707999998805462,
  'timings' => 
  array (
    'blocked' => 3.1049999992974335,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 16.77299999985553,
    'receive' => 3.8299999996525003,
    '_blocked_queueing' => 2.9799999992974335,
  ),
)