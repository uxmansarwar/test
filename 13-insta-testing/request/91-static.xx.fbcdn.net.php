...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.xx.fbcdn.net/rsrc.php/v3/yy/r/uk6-vmGVJGH.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'date',
        'value' => 'Sun, 05 May 2024 13:15:18 GMT',
      ),
      1 => 
      array (
      ...
      array (
        ...
        'value' => 'GOOD; q=0.7, rtt=110, rtx=0, c=33, mss=1232, tbw=36815, tp=41, tpl=0, uplat=4, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => '8xfcL04Ur5Ro4g9+H2TlbxOrBAJpdktODu4AWchH0oosBi5+8Ac9z8XHGupIkgCXInAusDL6LyIUBPlbu9V6zg==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Sun, 27 Apr 2025 16:01:00 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("XController",["XControllerURIBuilder","XRequest"],(function(a,b,c,d,e,f,g){a=function(){function a(a,b){this.$1=a,this.$2=b}var b=a.prototype;b.getURIBuilder=function(a){var b=this,d=new(c("XControllerURIBuilder"))(this.$1,this.$2);if(a){var e=this.getRequest(a);Object.keys(this.$2).forEach(function(a){var c=b.$2[a],f="";!c.required&&!Object.prototype.hasOwnProperty.call(c,"defaultValue")&&(f="Optional");f="get"+f+c.type;f=e[f](a);if(f==null||Object.prototype.hasOwnProperty.call(c,"defaultValue")&&f===c.defaultValue)return;c="set"+c.type;d[c](a,f)})}return d};b.getRequest=function(a){return new(c("XRequest"))(this.$1,this.$2,a)};a.create=function(b,c){return new a(b,c)};return a}();g["default"]=a}),98);',
  ...
  'startedDateTime' => '2024-05-05T15:32:23.329Z',
  'time' => 62.48500000037893,
  'timings' => 
  array (
    'blocked' => 37.912000000273345,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 18.680000000545753,
    'receive' => 5.892999999559834,
    '_blocked_queueing' => 37.80600000027334,
  ),
)