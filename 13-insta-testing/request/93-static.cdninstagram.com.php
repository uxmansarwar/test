...
return array (
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'date',
        'value' => 'Sun, 05 May 2024 13:14:09 GMT',
      ),
      1 => 
      array (
      ...
      array (
        ...
        'value' => 'GOOD; q=0.7, rtt=109, rtx=313, c=37, mss=1232, tbw=928358, tp=779, tpl=313, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'CKDY1iIgrIUnpG+VqH9HXTcCUqplpjxa2/XmcLbh9MFYNQuTetsp9Wlw8qkjwy2QMIM+jxlqLEvWrjl9w1JCEA==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Thu, 24 Apr 2025 18:18:56 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("PolarisIgLiteCarbonRoot.entrypoint",["JSResourceForInteraction"],(function(a,b,c,d,e,f,g){"use strict";a={getPreloadProps:function(a){return{queries:{}}},root:c("JSResourceForInteraction")("PolarisIgLiteCarbonRoot.react").__setRef("PolarisIgLiteCarbonRoot.entrypoint")};g["default"]=a}),98);',
  ...
  'startedDateTime' => '2024-05-05T15:32:23.399Z',
  'time' => 41.244000000006054,
  'timings' => 
  array (
    'blocked' => 3.204999999732128,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 35.331000000289755,
    'receive' => 2.7079999999841675,
    '_blocked_queueing' => 3.0779999997321283,
  ),
)