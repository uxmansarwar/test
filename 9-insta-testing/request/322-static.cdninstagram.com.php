...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/yU/r/ZJvjGYUdHqg.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=41, rtx=1360, c=89, mss=1232, tbw=4614659, tp=3832, tpl=1360, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'flqWuBmwlOhSmDfueVfnWkh1MrZ/olFa9vrQsVWie7JcO+qWe2ox1Se9GUdOQSR3+30JcDdpzdicAieQu+aXeg==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Mon, 21 Apr 2025 18:09:05 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("LSDeleteThenInsertMessagingPrivacySettings",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[];return b.sequence([function(c){return b.db.table(288).put({userId:a[0],readReceiptsDisabled:a[1],e2eeXmaPreviewsDisabled:a[3]})},function(a){return b.resolve(c)}])}e.exports=a}),null);',
  ...
  'time' => 4.810999999790511,
  'timings' => 
  array (
    'blocked' => 1.19799999963789,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 0.9949999997138511,
    'receive' => 2.6180000004387693,
    '_blocked_queueing' => 1.0439999996378901,
  ),
)