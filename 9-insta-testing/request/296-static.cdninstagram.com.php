...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/yX/r/UvxC-PHABSo.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
      ...
      array (
        'name' => ':path',
        'value' => '/rsrc.php/v3/yX/r/UvxC-PHABSo.js?_nc_x=Ij3Wp8lg5Kz',
      ),
      3 => 
      array (
        'name' => ':scheme',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=44, rtx=3177, c=71, mss=1232, tbw=11178259, tp=9243, tpl=3177, uplat=3, ullat=-1',
      ),
      21 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'n3+tdN/kEJa9CRMgMC6ncEHRKhf4BJrbibp64dtOqpvr7XG7+cRyJuceGhOn10fDw6udLolkQDhWqCjL6nzDQQ==',
      ),
    ),
    'cookies' => 
    array (
...
__d("PolarisStoriesV3HighlightsPageQuery_instagramRelayOperation",[],(function(a,b,c,d,e,f){e.exports="7539485752781000"}),null);
...
__d("PolarisStoriesV3HighlightsRoot.entrypoint",["JSResourceForInteraction","PolarisStoriesV3HighlightsPageQuery$Parameters"],(function(a,b,c,d,e,f,g){"use strict";a={getPreloadProps:function(a){var b,d=a.passthroughProps;a=a.routeProps.highlight_id;b=(b=d==null?void 0:d.initialHighlightIdParam)!=null?b:a;a=d==null?void 0:d.highlightIds;var e;a!=null?(d="Gallery",e={first:3,initial_reel_id:b,last:2,reel_ids:a}):(d="Standalone",e={first:1,initial_reel_id:b,reel_ids:[b]});return{extraProps:{highlightIds:a,initialHighlightId:b,variant:d},queries:{query:{parameters:c("PolarisStoriesV3HighlightsPageQuery$Parameters"),variables:e}}}},root:c("JSResourceForInteraction")("PolarisStoriesV3HighlightsRoot.react").__setRef("PolarisStoriesV3HighlightsRoot.entrypoint")};g["default"]=a}),98);',
  ...
  'startedDateTime' => '2024-04-27T15:01:07.227Z',
  'time' => 69.67299999996612,
  'timings' => 
  array (
    'blocked' => 2.9339999999923747,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0.3860000000000001,
    'wait' => 63.12099999994831,
    'receive' => 3.2320000000254367,
    '_blocked_queueing' => 1.5339999999923748,
  ),
)