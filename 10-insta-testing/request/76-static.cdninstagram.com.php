  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'value' => 'GOOD; q=0.7, rtt=50, rtx=963, c=270, mss=1232, tbw=3319747, tp=2748, tpl=963, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => '7zNsOlFud26sTTfjoUb77/Wy+Q6tKlm4W0ahxrQhtdkRbVDLSDgJbamumW5QzKiYLfrkfUv39yeE/dmI0Qt5NA==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Fri, 25 Apr 2025 01:27:13 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("LSWriteThreadCapabilities",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[],d=[];return b.sequence([function(d){return c[0]=b.i64.of_float(Date.now()),b.forEach(b.db.table(9).fetch([[[a[0]]]]),function(b){var c=b.update;b.item;return c({capabilities:a[1],capabilities2:a[2],capabilities3:a[3],capabilities4:a[4]})})},function(a){return b.resolve(d)}])}e.exports=a}),null);',
  ...
  'startedDateTime' => '2024-04-27T15:36:19.824Z',
  'time' => 191.60100000044622,
  'timings' => 
  array (
    'blocked' => 190.48000000089397,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 0.4090000004403992,
    'receive' => 0.7119999991118675,
    '_blocked_queueing' => 190.38800000089395,
  ),
)