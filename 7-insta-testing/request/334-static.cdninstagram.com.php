...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/y2/r/Nbx1KHPkOV6.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=48, rtx=14, c=579, mss=1232, tbw=2007834, tp=1707, tpl=14, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'W8AhVASZFE/IpS+4QNhFH1c2f24XNWqZfCyLtaZQmXQjdL8RGbfm8ODUlHlrgloTgW+TGIsGo4TmxEjtMp5T0g==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Fri, 18 Apr 2025 18:00:00 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("PolarisClipsHomeNonProfiledQuery$Parameters",["PolarisClipsHomeNonProfiledQuery_instagramRelayOperation","PolarisShareMenu.relayprovider"],(function(a,b,c,d,e,f){"use strict";a={kind:"PreloadableConcreteRequest",params:{id:b("PolarisClipsHomeNonProfiledQuery_instagramRelayOperation"),metadata:{is_distillery:!0},name:"PolarisClipsHomeNonProfiledQuery",operationKind:"query",text:null,providedVariables:{__relay_internal__pv__PolarisShareMenurelayprovider:b("PolarisShareMenu.relayprovider")}}};e.exports=a}),null);
__d("PolarisClipsHomeRootQuery$Parameters",["PolarisClipsHomeRootQuery_instagramRelayOperation","PolarisShareMenu.relayprovider"],(function(a,b,c,d,e,f){"use strict";a={kind:"PreloadableConcreteRequest",params:{id:b("PolarisClipsHomeRootQuery_instagramRelayOperation"),metadata:{is_distillery:!0},name:"PolarisClipsHomeRootQuery",operationKind:"query",text:null,providedVariables:{__relay_internal__pv__PolarisShareMenurelayprovider:b("PolarisShareMenu.relayprovider")}}};e.exports=a}),null);
...
__d("PolarisClipsViewerFollowingContent.entrypoint",["JSResourceForInteraction","PolarisClipsHomeNonProfiledQuery$Parameters"],(function(a,b,c,d,e,f,g){"use strict";a={getPreloadProps:function(a){var b={container_module:"clips_viewer_following_tab"};a.routeProps.media_id!=null&&(b=babelHelpers["extends"]({},b,{chaining_media_id:a.routeProps.media_id,should_refetch_chaining_media:!0}));return{queries:{polarisClipsHomeNonProfiledQuery:{options:{},parameters:c("PolarisClipsHomeNonProfiledQuery$Parameters"),variables:{data:b}}}}},root:c("JSResourceForInteraction")("PolarisClipsViewerFollowingContainer.react").__setRef("PolarisClipsViewerFollowingContent.entrypoint")};b=a;g["default"]=b}),98);
__d("PolarisClipsTabRoot.entrypoint",["JSResourceForInteraction","NestedRelayEntryPointBuilderUtils","PolarisClipsViewerDefaultContent.entrypoint","PolarisClipsViewerFollowingContent.entrypoint","qex"],(function(a,b,c,d,e,f,g){"use strict";a={getPreloadProps:function(a){return{entryPoints:{containerContent:h(a)},queries:{}}},root:c("JSResourceForInteraction")("PolarisClipsTabRoot.react").__setRef("PolarisClipsTabRoot.entrypoint")};function h(a){return a.routeParams.tab==="following"&&c("qex")._("887")===!0?d("NestedRelayEntryPointBuilderUtils").NestedRelayEntryPoint({entryPoint:b("PolarisClipsViewerFollowingContent.entrypoint"),entryPointParams:a}):d("NestedRelayEntryPointBuilderUtils").NestedRelayEntryPoint({entryPoint:b("PolarisClipsViewerDefaultContent.entrypoint"),entryPointParams:a})}g["default"]=a}),98);
...
__d("PolarisExploreRoot.entrypoint",["JSResourceForInteraction"],(function(a,b,c,d,e,f,g){"use strict";a={getPreloadProps:function(a){return{queries:{}}},root:c("JSResourceForInteraction")("PolarisExploreRoot.react").__setRef("PolarisExploreRoot.entrypoint")};g["default"]=a}),98);',
  ...
  'startedDateTime' => '2024-04-18T20:01:56.875Z',
  'time' => 162.63700000035897,
  'timings' => 
  array (
    'blocked' => 39.00000000041662,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 113.56599999978964,
    'receive' => 10.071000000152708,
    '_blocked_queueing' => 38.92000000041662,
  ),
)