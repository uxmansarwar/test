...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/yU/r/sWyNE8Tm0i2.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=44, rtx=14, c=579, mss=1232, tbw=2094298, tp=1785, tpl=14, uplat=0, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'KaVrVVrmN5rmaRP/es0qs90NORTZbAY7FsVYJt6/mp6VGM/P1nrLpjxTHKOparSj+Q6QchKcZnBL99BsEe/LlA==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Thu, 17 Apr 2025 18:55:14 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("LSDeserializeFromJsonIntoDictionaryV2.nop",["LSDict","LSJson","Promise","unrecoverableViolation"],(function(a,b,c,d,e,f,g){"use strict";var h;a=function(a,e,f){a=d("LSJson").parse(f,{useLSTypes:!0});if(a instanceof c("LSDict"))return(h||(h=b("Promise"))).resolve([a]);throw c("unrecoverableViolation")("unexpected Dictionary type","messenger_web_product")};g["default"]=a}),98);',
  ...
  'startedDateTime' => '2024-04-18T20:01:54.405Z',
  'time' => 19.874000000072556,
  'timings' => 
  array (
    'blocked' => 2.1050000000080327,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 8.084000000074127,
    'receive' => 9.684999999990396,
    '_blocked_queueing' => 1.8430000000080327,
  ),
)