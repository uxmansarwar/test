...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.xx.fbcdn.net/rsrc.php/v3iyFq4/yU/l/makehaste_jhash/g6YHqOGcDQx.js?_nc_x=A1gNAGKkBjX&_nc_eui2=AeFMZDFwvBWwloSrVCOcZuLs5tibQ8eQu_Lm2JtDx5C78npKjCPRY2YkiiBQtZDVQhJQ9ncwqTkxEMwpHfQ1VPFI',
    ...
    array (
      ...
      array (
        'name' => ':path',
        'value' => '/rsrc.php/v3iyFq4/yU/l/makehaste_jhash/g6YHqOGcDQx.js?_nc_x=A1gNAGKkBjX&_nc_eui2=AeFMZDFwvBWwloSrVCOcZuLs5tibQ8eQu_Lm2JtDx5C78npKjCPRY2YkiiBQtZDVQhJQ9ncwqTkxEMwpHfQ1VPFI',
      ),
      3 => 
      array (
        'name' => ':scheme',
    ...
    array (
      ...
      array (
        'name' => '_nc_eui2',
        'value' => 'AeFMZDFwvBWwloSrVCOcZuLs5tibQ8eQu_Lm2JtDx5C78npKjCPRY2YkiiBQtZDVQhJQ9ncwqTkxEMwpHfQ1VPFI',
      ),
    ),
    'cookies' => 
    array (
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'expires',
        'value' => 'Thu, 24 Apr 2025 18:18:59 GMT',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=38, rtx=0, c=12, mss=1392, tbw=2979, tp=-1, tpl=-1, uplat=11, ullat=-1',
      ),
      20 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'h6ySMesouwg2lGHryVpPqTDi7quJ+z8ckupGNejQrE2xavfHyJTAUSSAPlhs2RROhKVH4ceTP9hKOaQqRI/MGA==',
      ),
    ),
    'cookies' => 
    array (
...
__d("CometUFIDetachableComposerContext",["react"],(function(a,b,c,d,e,f,g){"use strict";var h;a=h||d("react");b=a.createContext({composerElement:null,focusComposer:null,setComposerElement:null,setFocusComposer:function(){}});g["default"]=b}),98);
...
__d("useTimeout",["clearTimeout","react","setTimeout","useEffectOnce","useUnsafeRef_DEPRECATED"],(function(a,b,c,d,e,f,g){"use strict";var h,i;b=i||d("react");var j=b.useCallback,k=b.useState;function a(a,b){b===void 0&&(b=!0);var d=(h||(h=c("useUnsafeRef_DEPRECATED")))(null),e=k(b),f=e[0],g=e[1],i=j(function(){g(!1),c("clearTimeout")(d.current)},[]),l=j(function(){g(!0),d.current=c("setTimeout")(function(){g(!1)},a)},[a]);e=j(function(){c("clearTimeout")(d.current),l()},[l]);c("useEffectOnce")(function(){b&&l();return i});return{pending:f,clear:i,restart:e}}g["default"]=a}),98);',
  ...
  'startedDateTime' => '2024-04-28T03:21:29.354Z',
  'time' => 225.50800000044546,
  'timings' => 
  array (
    'blocked' => 139.62600000023923,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 3.819999999999993,
    'wait' => 52.25800000042079,
    'receive' => 29.803999999785447,
    '_blocked_queueing' => 7.3350000002392335,
  ),
)