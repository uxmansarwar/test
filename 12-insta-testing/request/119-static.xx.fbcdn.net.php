...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.xx.fbcdn.net/rsrc.php/v3/yX/r/pFXMMl821hp.js?_nc_x=A1gNAGKkBjX&_nc_eui2=AeEflqcFk6lQcp_Tp0IvKU47uMwhXSWOoSq4zCFdJY6hKkQ3bbyYRZTEyHqTlCEMKqL9xT1Ii1o1il3FsioF1sqb',
    ...
    array (
      ...
      array (
        'name' => ':path',
        'value' => '/rsrc.php/v3/yX/r/pFXMMl821hp.js?_nc_x=A1gNAGKkBjX&_nc_eui2=AeEflqcFk6lQcp_Tp0IvKU47uMwhXSWOoSq4zCFdJY6hKkQ3bbyYRZTEyHqTlCEMKqL9xT1Ii1o1il3FsioF1sqb',
      ),
      3 => 
      array (
        'name' => ':scheme',
    ...
    array (
      ...
      array (
        'name' => '_nc_eui2',
        'value' => 'AeEflqcFk6lQcp_Tp0IvKU47uMwhXSWOoSq4zCFdJY6hKkQ3bbyYRZTEyHqTlCEMKqL9xT1Ii1o1il3FsioF1sqb',
      ),
    ),
    'cookies' => 
    array (
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'expires',
        'value' => 'Fri, 18 Apr 2025 20:05:16 GMT',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=38, rtx=0, c=12, mss=1392, tbw=2979, tp=-1, tpl=-1, uplat=10, ullat=-1',
      ),
      20 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'ZTFuokt8xxWc0G23bu0AIdHVm5cCh9uFxNzb/UhqkIjgYo/lNbkJOHirCwDxHoZsGbJGeW2FFJiSgBhVzmXJYg==',
      ),
    ),
    'cookies' => 
    array (
...
__d("setTimeoutCometLoggingPriWWW",["JSScheduler","setTimeoutCometInternals"],(function(a,b,c,d,e,f,g){"use strict";var h;function a(a,b){for(var c=arguments.length,e=new Array(c>2?c-2:0),f=2;f<c;f++)e[f-2]=arguments[f];return d("setTimeoutCometInternals").setTimeoutAtPriority_DO_NOT_USE.apply(d("setTimeoutCometInternals"),[(h||(h=d("JSScheduler"))).priorities.unstable_Low,a,b].concat(e))}g["default"]=a}),98);',
  ...
  'startedDateTime' => '2024-04-28T03:21:29.347Z',
  'time' => 247.70399999943038,
  'timings' => 
  array (
    'blocked' => 147.17999999960406,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 3.683000000000021,
    'wait' => 52.3489999998352,
    'receive' => 44.491999999991094,
    '_blocked_queueing' => 2.0029999996040715,
  ),
)