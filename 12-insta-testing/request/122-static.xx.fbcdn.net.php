...
return array (
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => ':path',
        'value' => '/rsrc.php/v3/yS/r/UC8FxchWUyr.js?_nc_x=A1gNAGKkBjX&_nc_eui2=AeET58xtZdMRfa008XSXBWic2n8oSvifndDafyhK-J-d0C19RtGrlh4m9lOwkNh74RkGrnyOKd33pqfPsBcZGdGq',
      ),
      3 => 
      array (
        'name' => ':scheme',
    ...
    array (
      ...
      array (
        'name' => '_nc_eui2',
        'value' => 'AeET58xtZdMRfa008XSXBWic2n8oSvifndDafyhK-J-d0C19RtGrlh4m9lOwkNh74RkGrnyOKd33pqfPsBcZGdGq',
      ),
    ),
    'cookies' => 
    array (
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'expires',
        'value' => 'Thu, 17 Apr 2025 16:46:42 GMT',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=38, rtx=0, c=12, mss=1392, tbw=63592, tp=-1, tpl=-1, uplat=12, ullat=-1',
      ),
      20 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'al+9p6Ae+BnatIzDbtYbcZ9MjRvmTial9OMIVe72CL2bZIOK5wXtJoMYBm2mPyd/1PsIgld3zrRuUCLTmzKMtg==',
      ),
    ),
    'cookies' => 
    array (
...
__d("CometProfiler.react",["hero-tracing"],(function(a,b,c,d,e,f,g){"use strict";g["default"]=d("hero-tracing").HeroReactProfiler}),98);
...
__d("useCometGHLDisplayMonitor",["CometGHLDisplayMonitor","GHLSurfaceContainerContext","react"],(function(a,b,c,d,e,f,g){"use strict";var h;b=h||d("react");var i=b.useContext,j=b.useEffect,k=b.useRef;function a(a,b){var e=k(null),f=i(c("GHLSurfaceContainerContext"));j(function(){var c=null,g=Date.now();if(f===null)return;if(!a)return;c=d("CometGHLDisplayMonitor").m(f,{onLogBlockCallback:b,startTime:g,targetRef:e});return function(){c&&c.dispose()}},[f,a,b]);return e}g["default"]=a}),98);',
  ...
  'startedDateTime' => '2024-04-28T03:21:29.351Z',
  'time' => 317.3240000005535,
  'timings' => 
  array (
    'blocked' => 143.20500000033044,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 3.562000000000012,
    'wait' => 133.1909999997483,
    'receive' => 37.36600000047474,
    '_blocked_queueing' => 4.372000000330445,
  ),
)