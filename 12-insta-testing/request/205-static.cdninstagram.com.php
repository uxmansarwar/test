...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3iTxa4/yy/l/makehaste_jhash/zGz0hj19SR4.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
      ...
      array (
        'name' => ':path',
        'value' => '/rsrc.php/v3iTxa4/yy/l/makehaste_jhash/zGz0hj19SR4.js?_nc_x=Ij3Wp8lg5Kz',
      ),
      3 => 
      array (
        'name' => ':scheme',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=37, rtx=2137, c=84, mss=1232, tbw=8078303, tp=6758, tpl=2137, uplat=0, ullat=-1',
      ),
      21 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'rPZopgBC21QMMRwRnc7p8sZ63uAMgsjh/StPV/ui7mHpQswJDXW9rjqCiKzJwn4pMT/ab+E69pnbnTjwTpNugQ==',
      ),
    ),
    'cookies' => 
    array (
...
__d("PolarisProfilePostsGridInstantModal.react",["CometRelay","PolarisInstantPostModal.react","PolarisIsLoggedInDesktop","PolarisPost.react","PolarisPostVariants","PolarisProfilePostsGridInstantModal_media.graphql","PolarisRoutes","isStringNullOrEmpty","react"],(function(a,b,c,d,e,f,g){"use strict";var h,i,j=(i||(i=d("react"))).unstable_useMemoCache,k=i;function a(a){var e=j(18),f=a.analyticsContext,g=a.media$key,i=a.mediaLinkBuilder,l=a.modalEntryPath,m=a.onClose,n=a.onOpen;a=a.postIDs;g=d("CometRelay").useFragment(h!==void 0?h:h=b("PolarisProfilePostsGridInstantModal_media.graphql"),g);if(!a.includes(g.pk))return null;var o;e[0]!==g?(o=g.original_height!=null&&g.original_width!=null?{height:g.original_height,width:g.original_width}:void 0,e[0]=g,e[1]=o):o=e[1];o=o;l=c("isStringNullOrEmpty")(l)?d("PolarisRoutes").FEED_PATH:l;var p=f+"Modal",q;e[2]===Symbol["for"]("react.memo_cache_sentinel")?(q=d("PolarisIsLoggedInDesktop").isLoggedInDesktop(),e[2]=q):q=e[2];e[3]!==p||e[4]!==g.pk||e[5]!==g.code?(q=k.jsx(c("PolarisPost.react"),{analyticsContext:p,autoplay:q,id:g.pk,isVisible:!0,shortcode:g.code,testid:void 0,variant:d("PolarisPostVariants").VARIANTS.flexible,visiblePosition:0}),e[3]=p,e[4]=g.pk,e[5]=g.code,e[6]=q):q=e[6];e[7]!==f||e[8]!==a||e[9]!==o||e[10]!==i||e[11]!==l||e[12]!==m||e[13]!==n||e[14]!==g.code||e[15]!==g.pk||e[16]!==q?(p=k.jsx(c("PolarisInstantPostModal.react"),{analyticsContext:f,combinedPostIds:a,dimensions:o,mediaLinkBuilder:i,modalEntryPath:l,onClose:m,onOpen:n,postCode:g.code,postId:g.pk,children:q}),e[7]=f,e[8]=a,e[9]=o,e[10]=i,e[11]=l,e[12]=m,e[13]=n,e[14]=g.code,e[15]=g.pk,e[16]=q,e[17]=p):p=e[17];return p}g["default"]=a}),98);
...
__d("PolarisProfileSuggestedUsersWithPreloadable.react",["CometRelay","PolarisProfileSuggestedUsers.next.react","PolarisProfileSuggestedUsersWithPreloadableDirectQuery.graphql","PolarisProfileSuggestedUsersWithPreloadableQuery.graphql","gkx","react"],(function(a,b,c,d,e,f,g){"use strict";var h,i,j,k=(j||(j=d("react"))).unstable_useMemoCache,l=j;function a(a){var e=k(5),f=a.clickPoint,g=a.query,j=a.userID;a=a.username;g=d("CometRelay").usePreloadedQuery(c("gkx")("1746")?h!==void 0?h:h=b("PolarisProfileSuggestedUsersWithPreloadableDirectQuery.graphql"):i!==void 0?i:i=b("PolarisProfileSuggestedUsersWithPreloadableQuery.graphql"),g);var m;e[0]!==g.xdt_api__v1__discover__chaining||e[1]!==f||e[2]!==j||e[3]!==a?(m=l.jsx(c("PolarisProfileSuggestedUsers.next.react"),{chainingResponse:g.xdt_api__v1__discover__chaining,clickPoint:f,userID:j,username:a}),e[0]=g.xdt_api__v1__discover__chaining,e[1]=f,e[2]=j,e[3]=a,e[4]=m):m=e[4];return m}g["default"]=a}),98);',
    ),
    'redirectURL' => '',
    'headersSize' => -1,
    'bodySize' => -1,
  ...
  'startedDateTime' => '2024-04-28T03:21:41.146Z',
  'time' => 106.77899999973306,
  'timings' => 
  array (
    'blocked' => 7.511999999301391,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0.3380000000000001,
    'wait' => 79.70900000029954,
    'receive' => 19.22000000013213,
    '_blocked_queueing' => 2.3029999993013917,
  ),
)