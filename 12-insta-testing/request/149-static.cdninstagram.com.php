  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=37, rtx=2137, c=57, mss=1232, tbw=7949423, tp=6617, tpl=2137, uplat=0, ullat=-1',
      ),
      21 => 
      array (
        'name' => 'x-fb-debug',
...
__d("LSTruncateQuietTime",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[];return b.sequence([function(a){return b.forEach(b.db.table(317).fetch(),function(a){return a["delete"]()})},function(a){return b.resolve(c)}])}e.exports=a}),null);',
  ...
  'startedDateTime' => '2024-04-28T03:21:34.235Z',
  'time' => 42.4910000001546,
  'timings' => 
  array (
    'blocked' => 1.8520000003803871,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0.66,
    'wait' => 38.99299999976251,
    'receive' => 0.9860000000116997,
    '_blocked_queueing' => 0.8850000003803871,
  ),
)