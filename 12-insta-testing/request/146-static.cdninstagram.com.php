...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/yr/r/bEmE1lDpjOk.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
      ...
      array (
        'name' => ':path',
        'value' => '/rsrc.php/v3/yr/r/bEmE1lDpjOk.js?_nc_x=Ij3Wp8lg5Kz',
      ),
      3 => 
      array (
        'name' => ':scheme',
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'expires',
        'value' => 'Sun, 27 Apr 2025 17:15:08 GMT',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=37, rtx=2137, c=57, mss=1232, tbw=7947663, tp=6611, tpl=2137, uplat=1, ullat=-1',
      ),
      21 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'FfQR0PCcGG14mm7gvgsh0HhwFteB04lBzJaiDwcGWoqF8WJjaBl1q+N93zjnmtR/nDLnswyj4Fp2j0lXn7DF2w==',
      ),
    ),
    'cookies' => 
    array (
...
__d("LSEpdCookieSettingsUpsert",["LSGetViewerFBID"],(function(a,b,c,d,e,f){function a(){var a=arguments,c=a[a.length-1],d=[],e=[];return c.sequence([function(e){return c.sequence([function(a){return c.storedProcedure(b("LSGetViewerFBID")).then(function(a){return a=a,d[0]=a[0],a})},function(b){return c.db.table(163).put({fbTrackersOnOtherCompanies:a[0],otherCompanyTrackersOnFoa:a[1]})}])},function(a){return c.resolve(e)}])}e.exports=a}),null);',
  ...
  'startedDateTime' => '2024-04-28T03:21:33.182Z',
  'time' => 52.35499999980675,
  'timings' => 
  array (
    'blocked' => 5.499999999922991,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0.899,
    'wait' => 42.63900000018661,
    'receive' => 3.3169999996971455,
    '_blocked_queueing' => 2.3719999999229913,
  ),
)