...
return array (
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.cdninstagram.com/rsrc.php/v3/y7/r/LcAw4wZ7kwE.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
      ...
      array (
        'name' => ':path',
        'value' => '/rsrc.php/v3/y7/r/LcAw4wZ7kwE.js?_nc_x=Ij3Wp8lg5Kz',
      ),
      3 => 
      array (
        'name' => ':scheme',
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'expires',
        'value' => 'Sun, 27 Apr 2025 17:15:04 GMT',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=38, rtx=1132, c=296, mss=1232, tbw=4873903, tp=4081, tpl=1132, uplat=2, ullat=-1',
      ),
      21 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'pFWtS/aEEpQrqObyyj8d1d9jJ+5xsLEzotgfMvu5BXhMWtjwSZZG/culLOpGn0tQSOea455YimdKKwmpIPsHyQ==',
      ),
    ),
    'cookies' => 
    array (
...
__d("LSWriteThreadCapabilities",[],(function(a,b,c,d,e,f){function a(){var a=arguments,b=a[a.length-1],c=[],d=[];return b.sequence([function(d){return c[0]=b.i64.of_float(Date.now()),b.forEach(b.db.table(9).fetch([[[a[0]]]]),function(b){var c=b.update;b.item;return c({capabilities:a[1],capabilities2:a[2],capabilities3:a[3],capabilities4:a[4]})})},function(a){return b.resolve(d)}])}e.exports=a}),null);',
  ...
  'startedDateTime' => '2024-04-28T03:21:26.823Z',
  'time' => 46.81599999912578,
  'timings' => 
  array (
    'blocked' => 3.6039999997451666,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0.4179999999999999,
    'wait' => 41.06799999987299,
    'receive' => 1.7259999995076214,
    '_blocked_queueing' => 1.7669999997451669,
  ),
)