...
return array (
    ...
    array (
      ...
      array (
        ...
        array (
          'functionName' => 'a',
          'scriptId' => '10',
          'url' => 'https://static.xx.fbcdn.net/rsrc.php/v3/yz/r/vSgPJr1eTij.js?_nc_x=Ij3Wp8lg5Kz',
          'lineNumber' => 59,
          'columnNumber' => 337,
        ),
        1 => 
      ...
      array (
        'id' => '4',
        'debuggerId' => '-7715978637923810350.6618748656924593699',
      ),
    ),
  ),
  '_priority' => 'High',
  ...
  array (
    'method' => 'GET',
    'url' => 'https://static.xx.fbcdn.net/rsrc.php/v3ieKI4/yU/l/en_GB/-bsZwTn4aTy.js?_nc_x=Ij3Wp8lg5Kz',
    'httpVersion' => 'h3',
    'headers' => 
    array (
      0 => 
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'date',
        'value' => 'Sat, 27 Apr 2024 15:00:28 GMT',
      ),
      1 => 
      array (
      ...
      array (
        ...
        'value' => 'EXCELLENT; q=0.9, rtt=41, rtx=0, c=25, mss=1232, tbw=39482, tp=45, tpl=0, uplat=1, ullat=-1',
      ),
      10 => 
      array (
        'name' => 'x-fb-debug',
        'value' => 'Zp1KTnXSI1hVrvd1th/+JVswaP2BRo4kzCJWe3L1Y8cXn9a8YXnAl1/fbAfo6VWWNe3UbPZ7yOpQhE+Eze/bDA==',
      ),
      11 => 
      array (
        'name' => 'last-modified',
      ...
      array (
        'name' => 'expires',
        'value' => 'Fri, 25 Apr 2025 17:03:52 GMT',
      ),
    ),
    'cookies' => 
    array (
...
__d("CometMenuFocusGroup",["fbt","CometComponentWithKeyCommands.react","CometKeys","FocusGroup.react","focusScopeQueries","react"],(function(a,b,c,d,e,f,g,h){"use strict";var i,j=i||d("react");b=d("FocusGroup.react").createFocusGroup(d("focusScopeQueries").tabbableScopeQuery);var k=b[0];e=b[1];function a(a){var b=[{command:{key:c("CometKeys").UP},description:h._("Previous item"),handler:function(){}},{command:{key:c("CometKeys").DOWN},description:h._("Next item"),handler:function(){}}];return j.jsx(c("CometComponentWithKeyCommands.react"),{commandConfigs:b,children:j.jsx(k,babelHelpers["extends"]({},a))})}a.displayName=a.name+" [from "+f.id+"]";d={FocusGroup:a,FocusItem:e};g["default"]=d}),226);
...
__d("useCometConfirmationDialog",["FDSDialogLoadingState.react","react","requireDeferred","useCometDeferredDialog"],(function(a,b,c,d,e,f,g){"use strict";var h,i=h||(h=d("react")),j=h.useCallback,k=c("requireDeferred")("CometConfirmationDialogImpl.react").__setRef("useCometConfirmationDialog");function l(){return i.jsx(c("FDSDialogLoadingState.react"),{})}l.displayName=l.name+" [from "+f.id+"]";function a(){var a=c("useCometDeferredDialog")(k,l);return j(function(b,c,d){d===void 0&&(d=function(){}),a(b,function(a){a?c():d()})},[a])}g["default"]=a}),98);
...
__d("setImmediate",["TimeSlice","TimerStorage","setImmediateAcrossTransitions"],(function(a,b,c,d,e,f,g){function a(a){var b,d=function(){c("TimerStorage").unset(c("TimerStorage").IMMEDIATE,b);for(var d=arguments.length,e=new Array(d),f=0;f<d;f++)e[f]=arguments[f];Function.prototype.apply.call(a,this,e)};c("TimeSlice").copyGuardForWrapper(a,d);for(var e=arguments.length,f=new Array(e>1?e-1:0),g=1;g<e;g++)f[g-1]=arguments[g];b=c("setImmediateAcrossTransitions").apply(void 0,[d].concat(f));c("TimerStorage").set(c("TimerStorage").IMMEDIATE,b);return b}g["default"]=a}),98);',
  ...
  'startedDateTime' => '2024-04-27T16:01:11.635Z',
  'time' => 4.079999998793937,
  'timings' => 
  array (
    'blocked' => 1.3559999991329388,
    'dns' => -1,
    'ssl' => -1,
    'connect' => -1,
    'send' => 0,
    'wait' => 1.7980000008620554,
    'receive' => 0.9259999987989431,
    '_blocked_queueing' => 1.2439999991329387,
  ),
)